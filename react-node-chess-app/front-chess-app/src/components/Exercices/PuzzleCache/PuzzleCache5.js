...
class PuzzleCache5 extends React.Component {
    static SQUARES = [
    ...
    customPieces = () => {
        ...
        roi.map((p) => {
            returnPieces[p] = ({ squareWidth }) => (
                <img src="https://i.imgur.com/Br9K7hP.png" alt="roi" style={{ width: squareWidth, height: squareWidth }}></img>
            );
            return null;
        });
        return returnPieces;
